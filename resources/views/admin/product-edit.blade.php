            ...
            <form class="tf-section-2 form-edit-product" method="POST" enctype="multipart/form-data"
                ...
                <div class="wg-box">
                    ...
                    <fieldset class="shortdescription">
                        ...
                        <div class="text-tiny">Do not exceed 1000 characters when entering the product name.</div>
                    </fieldset>
                    ...
                    <fieldset class="description">
                        ...
                        <div class="text-tiny">Do not exceed 10000 characters when entering the product name.</div>
                    </fieldset>
                    @error('description')
                        <div class="alert alert-danger text-center">{{ $message }}</div>
                    @enderror
                ...
                <div class="wg-box">
                    <fieldset>
                        ...
                        <div class="upload-image flex-grow">
                            <div class="item" id="imgpreview" style="display:block; cursor: pointer;" onclick="document.getElementById('myFile').click();">
                        ...
                        <div class="upload-image mb-16">
                            ...
                            @if(isset($product) && !empty($product->images))
                                @foreach(json_decode($product->images, true) as $image)
                                    <div class="item">
                                        <img src="{{ asset('uploads/products/gallery/' . $image) }}"
                                             class="effect8"
                                             alt="{{ $image }}">
                                    </div>
                                @endforeach
                        ...
                        <fieldset class="name">
                            ...
                            <div class="select mb-10">
                                <select class="" name="stock_status">
                                    <option class="text-green" value="instock" {{ $product->stock_status == 'instock' ? 'selected' : '' }}>In Stock</option>
                                    <option class="text-red" value="outofstock" {{ $product->stock_status == 'outofstock' ? 'selected' : '' }}>Out of Stock</option>
                                </select>
                            </div>
                        </fieldset>
                        @error('stock_status')
    ...
    <script>
        $(function (){
            ...
            $("#gFile").on("change", function (e){
                ...
                // Remove both existing images from preview and previously uploaded images
                $("#galUpload").siblings(".item").remove();
