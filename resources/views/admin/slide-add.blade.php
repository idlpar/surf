            ...
            <div class="wg-box">
                <form class="form-new-product form-style-1" method="POST" action="{{ route('admin.slide.store') }}" enctype="multipart/form-data">
                    ...
                    <fieldset class="name">
                        ...
                        <input class="flex-grow" type="text" placeholder="Use https:// before the website" name="link" tabindex="0" value="{{ old('link') }}" aria-required="true" required="">
                        @error('link')
                        <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </fieldset>
                    ...
                    <fieldset>
                        ...
                        <div id="imagePreview" style="display: none; margin-top: 15px; text-align: right;">
                            <img id="previewImage" src="" alt="Image Preview" style="max-width: 300px; height: auto; cursor: pointer;" onclick="triggerFileInput()"/>
                        </div>
                        <!-- Hidden File Input -->
