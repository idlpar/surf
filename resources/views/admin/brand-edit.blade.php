            ...
            <div class="wg-box">
                <form class="form-new-product form-style-1" action="{{ route('admin.brand.update') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <fieldset class="name">
                        ...
                        <textarea class="flex-grow" placeholder="Brand description" name="description" rows="4" aria-required="true">{{ $brand->description }}</textarea>
                    </fieldset>
                    @error('description')
                    <span class="alert alert-danger text-center">{{ $message }}</span>
                    @enderror
                        ...
                        <div class="upload-container">
                            ...
                            <div class="upload-preview" id="imagePreview">
                                <div class="no-preview cursor-pointer" id="noPreviewText">
                                    <img id="previewImage" src="{{ asset('uploads/brands') }}/{{ $brand->image }}" alt=" {{ $brand->name }}">
                                </div>
                            </div>
                            @endif
