        ...
        <div class="header-desk header-desk_type_1">
            <div class="logo"  class="flex items-center">
                    <a href="{{ route('home') }}"  class="flex items-center">
                        <img src="{{ asset('logos/tblue.svg') }}" alt="Tarpor" class="h-12 w-12 max-w-[220px] d-block" />
            ...
            <div class="header-tools d-flex align-items-center">
                ...
                @else
                    <div class="header-tools__item hover-container">
                        <a href="{{ Auth::user()->utype === 'admin' ? route('admin.dashboard') : route('user.dashboard') }}" class="header-tools__item">
