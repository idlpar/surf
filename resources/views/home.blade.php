                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                ...
                                <div class="text-center">
                                    <a href="{{ route('shop.category', ['category' => $category->slug ]) }}" class="menu-link fw-medium">{{ $category->name }}<br />Tops</a>
                                </div>
                            </div>
                            @endforeach
                        </div><!-- /.swiper-wrapper -->
                                            ...
                                            <a href="{{ route('shop.product.details', [ 'product_slug' => $product->slug ]) }}">
                                                ...
                                                @if(isset($product) && !empty($product->images))
                                                    @foreach(json_decode($product->images, true) as $image)
                                                        <img loading="lazy" src="{{ asset('uploads/products/gallery/' . $image) }}" width="258" height="313"
                                                             alt="{{ $image }}" class="pc__img pc__img-second">
                                                    @endforeach
                                                @endif
                                            </a>
                                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-6 col-md-4 col-lg-3">
                        <div class="product-card product-card_style3 mb-3 mb-md-4 mb-xxl-5">
                            ...
                            <div class="pc__info position-relative">
                                <h6 class="pc__title"><a href="{{ route('shop.product.details', [ 'product_slug' => $product->slug ]) }}">Cropped Faux Leather Jacket</a></h6>
