    ...
    <div class="container">
        <div class="header-desk header-desk_type_1">
            ...
            <div class="header-tools d-flex align-items-center">
                ...
                <?php else: ?>
                    <div class="header-tools__item hover-container">
                        <a href="<?php echo e(Auth::user()->utype === 'admin' ? route('admin.dashboard') : route('user.dashboard')); ?>" class="header-tools__item">
                            <span class="pr-2" > <?php echo e(Auth::user()->name); ?></span>
                            <svg class="d-block" width="20" height="20" viewBox="0 0 20 20" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                <use href="#icon_user" />
                            </svg>
...
<?php /**PATH D:\e-commerce\tarpor\resources\views/components/header.blade.php ENDPATH**/ ?>