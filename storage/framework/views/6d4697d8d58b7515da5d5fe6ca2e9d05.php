    ...
    <div class="container d-flex align-items-center h-100">
        ...
        <div class="logo">
            <a href="<?php echo e(route('home')); ?>">
                <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Uomo" class="max-w-[220px] d-block" style="margin-left: -10%;" />
            </a>
        </div>
            ...
            <div class="overflow-hidden">
                <ul class="navigation__list list-unstyled position-relative">
                    <li class="navigation__item">
                        <a href="<?php echo e(route('home')); ?>l" class="navigation__link">Home</a>
                    </li>
                    <li class="navigation__item">
...
<?php /**PATH D:\e-commerce\tarpor\resources\views/components/mob-header.blade.php ENDPATH**/ ?>