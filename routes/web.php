...
// Test Route (Accessible to guests)
...
|--------------------------------------------------------------------------
|
| These routes should only be accessible by verified users.
|
*/
...
// User Dashboard Route (Only accessible to verified users)
Route::middleware(['auth', 'verified'])->group(function () {
    Route::get('/user', [UserController::class, 'index'])->name('user.dashboard');
});

// Admin Routes (Only accessible to verified users and admins)
